/**
 * Evalium TypeScript SDK Quickstart Example.
 *
 * Demonstrates:
...
async function runQuickstart() {
  ...
  console.log("🚀 Evalium TypeScript SDK — End-to-End Evaluation");
    ...
    const testCases: TestCase[] = [
      {
        ...
        model_output:
          "International orders are eligible for return within 30 days. Shipping fees apply.",
        reference:
          "30-day return window for international orders with customer covering return shipping.",
      },
    ];
