...
Welcome to the **Evalium** examples directory. This folder provides complete, verified, end-to-end examples demonstrating how to evaluate LLM applications using our Python SDK, TypeScript SDK, CLI, and REST API.
