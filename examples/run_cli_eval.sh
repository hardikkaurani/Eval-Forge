#!/usr/bin/env bash
# ================================================================
# Evalium CLI Evaluation Runner Walkthrough
# ================================================================
set -e
...
echo "=========================================================="
echo "🚀 Running Evalium CLI Evaluation Suite"
echo "Target Base URL: ${BASE_URL}"
echo "=========================================================="

# 1. Configure base URL and authenticate
echo "Step 1: Configuring CLI endpoint and authentication..."
evalium config set --base-url "${BASE_URL}"
evalium auth login --key "${API_KEY}"
evalium auth status

# 2. List or create project
echo -e "\nStep 2: Listing projects..."
evalium projects list --page 1 --page-size 5
