...
async def get_advanced_ai_dashboard_summary(
    ...
    overall_readiness = (security_score + safety_score + rag_score + convo_score + agent_score) / 5.0
    insights = service.generate_ai_insights(safety_score, risk_assessment.overall_risk_score)
