...
from app.platform.schemas import WebhookSubscriptionCreate, WebhookSubscriptionResponse, WebhookDeliveryResponse
...
@router.post("", response_model=ApiResponse[WebhookSubscriptionResponse], status_code=201)
...
@router.get("/{subscription_id}/deliveries", response_model=ApiResponse[List[WebhookDeliveryResponse]])
